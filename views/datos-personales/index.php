...
<div class="datos-personales-index">
    ...
    $gridColumn = [
        ...
        [
                'attribute' => 'comunas_id',
                'label' => 'Comunas',
                'value' => function($model){                   
                    return $model->comunas->nombre;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Comunas::find()->asArray()->all(), 'id', 'nombre'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Comunas', 'id' => 'grid-datos-personales-search-comunas_id']
            ],
        'nac',
        'cedula',
        'primer_apellido',
